module Playground.Square where
...
{- J²: The elimination principle for squares.
--
--
-}
module _ {A : Type ℓ} (x₀₀ : A)
  (P : ∀ {x₀₁} {x₀₋ : x₀₀ ≡ x₀₁} {x₁₀ x₁₁ : A} {x₁₋ : x₁₀ ≡ x₁₁} {x₋₀ : x₀₀ ≡ x₁₀} {x₋₁ : x₀₁ ≡ x₁₁} → Square x₀₋ x₁₋ x₋₀ x₋₁ → Type ℓ')
  (d : P (λ i j → x₀₀))
  ...
  J² : P s
  J² = transport {A = P (λ i j → x₀₀)} {B = P s} filler d where
    filler : P (λ i i → x₀₀) ≡ P s
    filler k = P λ i j → s (i ∧ k) (j ∧ k)
